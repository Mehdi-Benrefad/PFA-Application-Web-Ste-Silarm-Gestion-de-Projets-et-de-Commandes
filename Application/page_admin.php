...
<body>
	...
	<section>
		...
		<p class="traveau_icone">
			<a href="liste_travaux_de_construction.php">
				<img src="travaux.png" alt="Demande de Traveaux"> <br>Demandes de Traveaux
			</a>
		</p>

		<p class="fournitures_icone">
			<a href="liste_produits.php">
				<img src="produits.png" alt="Demande de fournitures"> <br>Demandes de fournitures
			</a>
		</p>

		<p class="clients_icone">
			<a href="Clients.php">
				<img src="clients.png" alt="Liste Des C lients"> <br> Clients
			</a>
		</p>
	</section>
