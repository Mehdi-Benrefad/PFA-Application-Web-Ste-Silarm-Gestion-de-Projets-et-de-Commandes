...
<body>
	...
	<section>
		<br>
		<br>
		<p class="liste_clients_icone">
			<a href="liste_clients.php">
				<img src="recherche_clients.png" alt="Demande de Traveaux"> <br>Liste des clients
			</a>
		</p>

		<p class="recherche_clients_icone">
			<a href="recherche_clients.php">
				<img src="recherche_clients.png" alt="Liste Des C lients"> <br> Recherche par ID
			</a>
		</p>
	</section>
