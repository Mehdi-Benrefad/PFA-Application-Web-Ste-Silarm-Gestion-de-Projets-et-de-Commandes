...
<body>
	...
	<section>
		<form method="POST" action="validation_traveaux.php">
			...
			<p class="description_bloc">
				<label class="label_description" ><strong> Description Du Projet &nbsp;&nbsp;:</strong></label>
				<textarea spellcheck="description" name="description" id="description" autofocus maxlength="500" size="100"></textarea>
			</p> 

			<p>
				<input class="commander" type="submit" name="commander" value="Envoyer">
			</p>
