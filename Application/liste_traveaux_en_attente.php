...
<body>
	...
	<h3 style="text-align: center;">
			LISTE DES TRAVEAUX EN ATTENTE:
	</h3>
	<section>
		<?php
			$bdd = new PDO('mysql:host=localhost;dbname=silarm;charset=utf8', 'root', '');
			$reponse=$bdd->query('select * from traveaux where etat="EN ATTENTE" order by id_client');
		 ?>
